...
8 pillars. 52 techniques. Each one exists because something went wrong and we built the system to prevent it.

A thread on what we learned running a 10-agent team for 13 days straight:
...
No theory. Pure operational knowledge from production use.
...
Because I spent 20 years leading distributed teams in high-stakes environments. 92 Marines. Red team ops. The patterns transfer 1:1.

Trust tiers = security clearances
Mission briefings = agent invocation
...
Solo practitioner? Start with 10 core techniques.
Small team? Add governance (~25 techniques).
Enterprise? Full framework, all 52.
